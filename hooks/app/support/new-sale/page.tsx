...
import { ArrowLeft, Check, CreditCard, Building2, UserPlus, AlertCircle, Menu, Paperclip, X, FileText, Image, File } from "lucide-react"
...
export default function SupportNewSalePage() {
  ...
  const [formData, setFormData] = useState({
    ...
    customPrice: "",
    // Medio de pago abono
    paymentMethodAbono: "credit_card",
    cardBrand: "visa",
    cbuNumber: "",
    // Medio de pago instalacion
    paymentMethodInstallation: "transfer",
    // Observaciones
    description: "",
  })
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!selectedSellerId && !selectedSupervisorId) {
      toast({
        title: "Error",
        description: "Debes asignar la venta a un vendedor o supervisor",
        variant: "destructive",
      })
      return
    }
    ...
    const saleData = {
      ...
      sellerId: selectedSellerId || selectedSupervisorId, // Asignar al usuario seleccionado
    ...
    try {
      ...
      const result = await supportAPI.createSale(token, saleData as any)
      ...
      toast({
        ...
        description: installationFiles.length > 0 
          ...
          : "La venta se ha registrado correctamente y asignada al usuario seleccionado",
      })
      router.push("/support/sales")
    } catch (error) {
      toast({
        title: "Error",
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">Registra una venta asignada a un vendedor o supervisor</p>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {currentStep === 1 && (
                <Card className="border-border/50 bg-card/50">
                  <CardHeader>
                    <CardTitle>Seleccionar Plan y Asignar Usuario</CardTitle>
                    <CardDescription>Elige el plan y a quien se le asignara la venta</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-6">
                    ...
                    <FieldGroup>
                      <Field>
                        ...
                        <p className="text-xs text-muted-foreground mt-1">
                          Si la venta es directa de un supervisor, seleccionalo aqui
                        </p>
                      </Field>
                    </FieldGroup>
                    ...
                    <FieldGroup>
                      <Field>
                        ...
                        <Select value={selectedSellerId} onValueChange={(value) => {
                          ...
                          // Si selecciona vendedor, limpiar supervisor (a menos que tenga uno asignado)
                        }}>
                          <SelectTrigger className="bg-secondary/50">
                        ...
                        <p className="text-xs text-muted-foreground mt-1">
                          Selecciona el vendedor al que se le asignara esta venta
                        </p>
                      </Field>
                    </FieldGroup>
                    ...
                    <div className="flex justify-end">
                      <Button
                        ...
                        disabled={!selectedPlan || (!selectedSellerId && !selectedSupervisorId)}
                  ...
                  <CardHeader>
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <CardDescription>
                          Debe ser el contacto de un familiar, vecino o amigo.
                        </CardDescription>
                      </div>
                    </div>
                  </CardHeader>
                    ...
                    <div className="bg-orange-500/10 border border-orange-500/30 rounded-lg p-4 mb-6">
                      <div className="flex items-start gap-2">
                        ...
                        <p className="text-sm text-orange-200">
                          Este contacto es obligatorio para poder proceder con la instalacion.
                        </p>
                      </div>
                    </div>
                        ...
                        <div className="grid gap-4 md:grid-cols-2 text-sm">
                          ...
                          <div>
                            ...
                            <p className="font-semibold">
                              {selectedSellerId 
                                ? sellers.find(s => s._id === selectedSellerId)?.name || "-"
                                : selectedSupervisorId 
                                  ? supervisors.find(s => s._id === selectedSupervisorId)?.name + " (Supervisor)"
                                  : "-"
                              }
                            </p>
                          </div>

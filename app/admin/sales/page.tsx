...
function AdminSalesContent() {
  ...
  const filterSales = () => {
    ...
    // Filtrar por mes seleccionado segun reglas de negocio:
                    ...
                    <input
                      ...
                      onChange={async (e) => {
                        ...
                        try {
                          ...
                          fetchSales()
                          // Actualizar el selectedSale para ver los cambios
                          const updated = await salesAPI.getAdminSales(token)

...
import { 
  Search, Plus, Edit2, Trash2, Phone, Mail, 
  UserPlus, Target, TrendingUp, Users, Calendar,
  MessageSquare, Eye, Filter, X
} from "lucide-react"
...
export default function AdminLeadsPage() {
  ...
  const handleDelete = async () => {
    ...
    try {
      await leadsAPI.delete(token, selectedLead._id)
      toast({
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="text-muted-foreground">Administra y asigna leads a los vendedores</p>
          </div>
      ...
      <AlertDialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Esta seguro de que desea eliminar el lead de {selectedLead?.name}? Esta accion no se puede deshacer.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
